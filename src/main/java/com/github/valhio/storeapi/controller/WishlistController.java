...
public class WishlistController {
    ...
    public ResponseEntity<Favorite> removeProductFromFavourites(@PathVariable Long productId, @PathVariable String userId) throws UserNotFoundException, ProductNotFoundException {
    ...
    public ResponseEntity<Favorite> getFavouriteByUserIdAndProductId(@PathVariable Long productId, @PathVariable String userId) throws ProductNotFoundException {
