...
public class ReviewCommentController {
    ...
    public ResponseEntity<ReviewComment> addComment(@PathVariable String productReviewId, @RequestBody ReviewCommentRequest reviewCommentRequest, @AuthenticationPrincipal UserPrincipal auth) throws UserNotFoundException, ProductReviewNotFoundException {
    ...
    public ResponseEntity<List<ReviewComment>> getAllCommentsForReview(@PathVariable String productReviewId) {
    ...
    public ResponseEntity<Boolean> hasCommented(@PathVariable String productReviewId, @AuthenticationPrincipal UserPrincipal auth) {
