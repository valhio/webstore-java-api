...
public interface UserService {
    ...
    User addNewUser(User user) throws EmailExistException, IOException;
    ...
    User update(User newUser, String originalEmail) throws EmailExistException, IOException, EmailNotFoundException;
